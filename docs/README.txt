...
An impactor-inspired sample chamber for prototype sensor performance evaluation and characterization has been developed by the [http://www.nrl.navy.mil/ U.S. Naval Research Laboratory]. The sample chamber has a cone geometry to create an uniform vapor front that is delivered to a prototype sensor housed in a pin-grid array. The wall temperature and flow rate through the chamber are controlled by an [http://www.omega.com/ppt/pptsc.asp?ref=CSi32_Series Omega CSi32] temperature controller and a [http://www.sierrainstruments.com/products/c100.html Sierra Instruments M100 Smart Trak 2] mass flow controller, respectively. This application monitors and controls the temperature and flow rate for a sample chamber.
